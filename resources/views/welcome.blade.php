            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div
                    ...
                    <div class="flex flex-col items-center text-center">
                        ...
                        <p class="text-white/90 mb-6">
                            Ajukan berbagai surat administrasi seperti surat keterangan, domisili, usaha, dan lainnya
                ...
                <div
                    ...
                    <div class="flex flex-col items-center text-center">
                        ...
                        {{-- Description --}}
                        <p class="text-white/90 mb-6">
                            Sampaikan keluhan, aspirasi, atau masukan kepada perangkat desa secara cepat, transparan,
                            dan tuntas.
                        </p>
                        {{-- CTA --}}
                    ...
                    <div
                        ...
                        <div class="p-4 flex flex-col justify-between flex-grow">
                            <div>
                                ...
                                <h3 class="text-base font-semibold text-gray-800 mb-1 line-clamp-2">Judul Berita Desa
                                    Singkat & Gacor</h3>
                            ...
                            <div class="mt-auto flex flex-col space-y-2">
                                <a href="#" class="text-primary-600 text-sm font-medium hover:underline">Baca
                                    Selengkapnya →</a>
