    ...
    <section class="bg-gray-100 py-8">
        <div class="container mx-auto px-4" x-data="pendudukData()">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-4 mb-12">
                @foreach ([['label' => 'Total Penduduk', 'value' => '1.653 Jiwa'], ['label' => 'Kepala Keluarga', 'value' => '603 Jiwa'], ['label' => 'Laki-laki', 'value' => '838 Jiwa'], ['label' => 'Perempuan', 'value' => '815 Jiwa']] as $stat)
                    <div
                        class="bg-white rounded-2xl shadow hover:shadow-lg transition-transform transform hover:-translate-y-1 p-4 flex flex-col items-center text-center">
                        <div
                            class="w-16 h-16 bg-blue-100 rounded-full mb-4 flex items-center justify-center text-blue-500">
            ...
            <div class="bg-white rounded-2xl shadow p-6 mb-12">
                ...
                <div class="mt-4 text-sm text-gray-600 space-y-2">
                    <p>Untuk laki-laki, kelompok umur <span class="font-semibold">20-24</span> tertinggi: <span
                            class="font-semibold">98 orang (15.43%)</span>.</p>
                    <p>Untuk perempuan, kelompok umur <span class="font-semibold">20-24</span> tertinggi: <span
                            class="font-semibold">69 orang (9.91%)</span>.</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow p-6 mb-12">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-6 text-center">
                    @foreach ([['status' => 'Belum Kawin', 'jumlah' => 1308], ['status' => 'Kawin', 'jumlah' => 20], ['status' => 'Cerai Mati', 'jumlah' => 1], ['status' => 'Cerai Hidup', 'jumlah' => 0], ['status' => 'Kawin Tercatat', 'jumlah' => 0], ['status' => 'Kawin Tidak Tercatat', 'jumlah' => 0]] as $marital)
                        <div
                            class="flex flex-col items-center p-4 bg-gray-100 rounded-lg hover:shadow-lg transition-transform transform hover:-translate-y-1">
