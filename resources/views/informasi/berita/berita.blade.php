<x-layout>
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center mt-6 text-xs text-gray-400">
                            ...
                            <a href="/informasi/berita/detail/{{ $item->id_berita }}"
                                class="bg-green-600 hover:bg-green-700 text-white px-4 py-1 rounded-full text-sm transition">Detail</a>
                        </div>
                    </div>
                </div>
            @endforeach
    ...
    <section class="py-8">
        <div class="flex justify-center items-center gap-2">
            <button
                class="w-10 h-10 flex items-center justify-center border rounded-full hover:bg-gray-100 transition">&lt;</button>
            <button
                class="w-10 h-10 flex items-center justify-center border rounded-full bg-green-500 text-white hover:bg-green-600 transition">1</button>
            <button
                class="w-10 h-10 flex items-center justify-center border rounded-full hover:bg-gray-100 transition">2</button>
            <button
                class="w-10 h-10 flex items-center justify-center border rounded-full hover:bg-gray-100 transition">3</button>
            <button
                class="w-10 h-10 flex items-center justify-center border rounded-full hover:bg-gray-100 transition">4</button>
            <button
                class="w-10 h-10 flex items-center justify-center border rounded-full hover:bg-gray-100 transition">&gt;</button>
        </div>
    </section>
