<nav x-data="{
    ...
    <div x-show="mobileMenuOpen" x-transition
        ...
        <div class="py-3 px-4 space-y-2 text-sm">
            ...
            <a href="/profil-desa" class="flex items-center gap-2 hover:bg-gray-100 p-2 rounded-xl transition">
                <!-- Info -->
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-800" viewBox="0 0 24 24">
            ...
            <a href="{{ route('administrasi') }}" class="flex items-center gap-2 hover:bg-gray-100 p-2 rounded-xl transition">
                <!-- Document -->
            ...
            <a href="/layanan/pengaduan" class="flex items-center gap-2 hover:bg-gray-100 p-2 rounded-xl transition">
                <!-- Chat -->
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-800" viewBox="0 0 24 24">
                    <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                        stroke-width="1.5"
            ...
            <a href="/informasi/berita-desa" class="flex items-center gap-2 hover:bg-gray-100 p-2 rounded-xl transition">
                <!-- Newspaper -->
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-800" viewBox="0 0 24 24">
                    <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                        stroke-width="1.5"
            ...
            <a href="/informasi/apbdes" class="flex items-center gap-2 hover:bg-gray-100 p-2 rounded-xl transition">
                <!-- Chart -->
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-800" viewBox="0 0 24 24">
                    <path fill="currentColor"
            ...
            <a href="/informasi/kependudukan" class="flex items-center gap-2 hover:bg-gray-100 p-2 rounded-xl transition">
                <!-- Users -->
