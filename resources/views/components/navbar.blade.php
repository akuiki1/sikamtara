        ...
        @auth
            ...
            <div class="flex items-center justify-end">
                ...
                <div class="" x-data="{ open: false }">
                    <!-- Tombol Icon -->
                    @if (in_array(Auth::user()->status_verifikasi, ['Belum Terverifikasi', 'Menunggu Verifikasi']))
                        <button @click="open = !open" @click.away="open = false"
                            class="flex items-center justify-center w-5 h-5 rounded-full text-yellow-400 hover:scale-105 transition">
                    ...
                    <div x-show="open" x-transition
                        class="absolute right-0 mt-2 max-w-sm w-96 rounded-lg text-sm text-gray-800">
                        <div class="flex justify-center">
                            @if (Auth::user()->status_verifikasi === 'Belum Terverifikasi')
                                <div
                                    class="w-fit px-4 py-2 bg-yellow-100 text-yellow-700 shadow-lg rounded-xl text-sm flex items-center gap-2">
                ...
                <div class="flex gap-8 md:hidden">
                    ...
                    <button @click="mobileMenuOpen = !mobileMenuOpen"
                        class="md:hidden text-xl focus:outline-none text-white">
