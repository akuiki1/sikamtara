                    ...
                    @foreach ($programs as $program)
                            ...
                            <form :action="'{{ url('/admin/program') }}/' + selectedProgram.id" method="POST"
                                ...
                                <div>
                                    ...
                                    <input type="text" name="jenis_program"
                                        x-model="selectedProgram.jenis_program"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="date" name="tanggal_mulai"
                                            :value="selectedProgram.tanggal_mulai"
                                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                                    </div>
                                    <div>
                                ...
                                <div>
                                    ...
                                    <template x-if="fileTooLarge">
                                        <p class="text-sm text-red-600 mt-2">Ukuran file terlalu besar. Maksimal 2MB.
                                        </p>
                                    </template>
                                </div>
                        ...
                        <x-modal show="showDelete" title="Hapus Program Pembangunan">
                            <form action="{{ route('admin.program.destroy', $program->id) }}" method="POST"
                                ...
                                <p>Apakah Anda yakin ingin menghapus program
